// .-----------------------------------------------.       .-----------------------------------------------.
// |   `   | Q/COL | W/COL |   E   |   R   |   T   |       |   Y   |   U   |   I   |   O   |   P   |   \   |
// |-------+-------+-------+-------+-------+-------|       |-------+-------+-------+-------+-------+-------|
// |  Tab  |   A   |   S   |   D   |   F   |   G   |       |   H   |  J/BT |   K   |L/MEDIA| ;/CHAR|   '   |
// |-------+-------+-------+-------+-------+-------|       |-------+-------+-------+-------+-------+-------|
// | [/SHFT|  Z/FN | X/NUM |   C   | V/NAV |   B   |       |   N   |   M   |   ,   |   .   |   /   | ]/SHFT|
// '-----------------------+-------+-------+-------|       |-------+-------+-------+-----------------------'
//                         |ESC/GUI|ENT/ALT|  SPC  |       |BSP/CTR| -/ALT | =/GUI |
//                         '-----------------------'       '-----------------------'

#define QwertyL1 &kp GRAVE                &kp Q    &kp W    &kp E         &kp R         &kp T     /**/ &kp Y           &kp U           &kp I           &kp O    &kp P       &kp BSLH
#define QwertyL2 &kp TAB                  &kp A    &kp S    &kp D         &kp F         &kp G     /**/ &kp H           &lt 5 J         &kp K           &lt 6 L  &lt 7 SEMI  &kp SQT
